    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eligible_raids_override', models.SmallIntegerField(default=0)),
                ('attended_raids_override', models.SmallIntegerField(default=0)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boss', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='guild_management.Npc')),
                ('character', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='guild_management.Character')),
